...
public class LibraryContext : DbContext
{
    ...
    {
        // Si la factory de diseño ya configuró, no sobreescribir.
        if (optionsBuilder.IsConfigured) return;

        // Resolver ruta del PROJECT ROOT y ./data/books.db
    ...
    {
        // Mapear la tabla intermedia como TitlesTags
        ...
        // Unicidades para evitar duplicados
        ...
        // Orden de columnas de Title: TitleId, AuthorId, TitleName
    ...
    // Intenta ubicar la raíz del proyecto buscando un *.csproj ascendiendo desde bin/...
    private static string GetProjectRoot()
    {
        ...
        // Fallback: si no se encontró, usar el CurrentDirectory
